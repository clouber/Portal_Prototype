...
WSRP.Markup = function () {
    ...
    */
    this.getResource = function (registrationContext, portletContext,
    ...
    */
    this.initCookie = function (registrationContext, userContext) {};
    ...
    * @return {Extension} ReturnAny.
    */
    this.releaseSessions = function (registrationContext, sessionIDs,
        userContext) {};
...
WSRP.Registration = function () {
    ...
    */
    this.modifyRegistration = function (registrationContext, registrationData,
        userContext) {};
...
/**
* The Portlet Management interface (WSRP 2.0), an optional interface, defines
* operations for getting Portlet metadata, cloning Portlets for further
* customization and interacting with the property interface.
* @interface
* @class
*/
WSRP.PortletManagement = function () {
    'use strict';
...
/**
* 7.1.13 PortletLifetime Type
* The PortletLifetime structure represents the lifetime for a single Portlet.
* @type WSRP.PortletLifetime
* @class WSRP.PortletLifetime
*/
WSRP.PortletLifetime = function () {
    'use strict';
    /** @type PortletContext */
    this.portletContext = new WSRP.PortletContext();
...
* The GetPortletsLifetimeResponse structure contains the fields that
* getPortletsLifetime can return.
* @type WSRP.GetPortletsLifetimeResponse
* @class WSRP.GetPortletsLifetimeResponse
*/
WSRP.GetPortletsLifetimeResponse = function () {
    'use strict';
    /** @type Array(PortletLifetime) */
    this.portletLifetimes = [];
...
* The SetPortletsLifetimeResponse structure contains the fields that
* setPortletsLifetime can return.
* @type WSRP.SetPortletsLifetimeResponse
* @class WSRP.SetPortletsLifetimeResponse
*/
WSRP.SetPortletsLifetimeResponse = function () {
    'use strict';
    /** @type Array(PortletLifetime) */
    this.updatedPortlets = [];
