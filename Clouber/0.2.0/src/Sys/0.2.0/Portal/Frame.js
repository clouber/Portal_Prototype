    ...
    */
    this.getHtml = function () {
        return '<div class="Clouber_Frame" id="' +
            ...
            '"><div class="Clouber_Frame_b FB_S1">' +
            '<div class="Clouber_Frame_b FB_S2">' +
            '<div class="Clouber_Frame_b FB_S3">' +
            '<div class="Clouber_Frame_b FB_S4">' +
        ...
        if (index < 0) {
            if (params) {
                Clouber.document.removeClass(this.getContext().tag +
                        " .Clouber_Frame_b", "Clouber_Frame_b_hide");
            } else {
...
Clouber.Sys.Portal.Frame = function (params) {
    ...
    */
    this.init = function (params) {
        ...
        // set frame style
        this.view.setBorder(-1, this.getContext().border);
